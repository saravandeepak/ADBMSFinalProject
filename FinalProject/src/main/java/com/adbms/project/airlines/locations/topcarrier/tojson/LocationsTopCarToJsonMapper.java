package com.adbms.project.airlines.locations.topcarrier.tojson;
...
public class LocationsTopCarToJsonMapper extends Mapper<LongWritable, Text, Text, NullWritable>{
	static int count = 0;
